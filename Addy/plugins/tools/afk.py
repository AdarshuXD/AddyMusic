...
from Addy.mongo.readable_time import get_readable_time
from Addy.mongo.afkdb import add_afk, is_afk, remove_afk



@app.on_message(filters.command(["afk", "brb", "bye"], prefixes=["/", "!", "Adarshu", "Adarshu"]))
