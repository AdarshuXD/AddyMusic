    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/6ee7b51e8b25d91aeb237.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💒 Whisper",
            description=f"@MrAddyBot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@MrAddyBot (Target Username or ID) (Your Message).\n\n**Example:**\n@MrAddyBot @username I Wanna Phuck You"),
            thumb_url="https://telegra.ph/file/6ee7b51e8b25d91aeb237.jpg",
            reply_markup=switch_btn
        )
    ]
